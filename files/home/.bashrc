...
# 2. check if we are in a terminal that supports color (in this case xterm-color)
case "$TERM" in
    xterm-color) color_prompt=yes;;
esac

# 3. check for color support in the terminfo databse
...
# 4. setup the prompt accordingly
